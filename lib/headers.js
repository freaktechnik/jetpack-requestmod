...
/** @lends module:lib/headers.Headers.prototype */
{
     ...
     * implements an interface similar to the JS `Map` object. It also
     * implements the iterable protocol, so you can iterate over it with
     * for...of loops. Each value when iterating is an object with a property
     * `header` storing the name of the header and `value` containing the
     * header's value.
     * @constructs
     * @extends external:sdk/core/disposable.Disposable
     * @argument {external:nsIHttpChannel} channel
     * @argument {module:requestmod.INCOMING|module:requestmod:OUTGOING} direction
     * @alias module:lib/headers.Headers
     */
